...
local function BuildMainUI()
    ...
    local Window = redzlib:MakeWindow({ Name="TRX HUB", SubTitle="الدارك مع تعاون TRX" })
    ...
    local function toggleHub()
        ...
        hudBtn.Text=hubShown and "▼  FR HUB" or "▲  FR HUB"
...
FaresTab:AddButton({
     ...
     Notify("سكربتات الدارك", "تم تشغيل طياران FLY", 3)
        end
    })
...
RunService.RenderStepped:Connect(function()
    ...
    elseif selected == 3 then
        ...
        Lighting.OutdoorAmbient = Color3.fromRGB(255,140,80)
            ...
            Notify("سكربتات TRX", "تم تشغيل الشادر", 3)
        end
    })
    ...
    FaresTab:AddParagraph({"ملاحظة مهمة", "الـ Noclip بيفيدك جدا في اختراق البيوت لما تكون عايز تتج😂"})
    FaresTab:AddToggle({
...
ShowIntro(function()
    ...
    task.spawn(function()
        ...
        if success then
            Notify("TRX Name", "تم التحميل بنجاح", 3) 

           
        else
            Notify("TRX Name", "فشل التحميل تلقائيًا", 3) 
